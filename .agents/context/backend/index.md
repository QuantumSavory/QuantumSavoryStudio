...
| --- | --- | --- | --- |
| [Architecture](architecture.md) | Explanation | Tracing boot, ownership, state, or boundaries | Looking up one route shape |
...
| [Constructor and tag metadata](constructor-and-tag-metadata.md) | Reference | Changing catalogs, typed inputs, tags, or queries | Editing UI layout |
