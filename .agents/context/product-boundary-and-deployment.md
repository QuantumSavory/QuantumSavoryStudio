...
Only the root project declares QuantumSavory compatibility, at `0.8`. Both root and test
projects select exact reachable revision
`3cd578f5073f6f227c69842f33104da13290a004` in their `[sources]` tables, and no Julia
manifest is committed. That source pin is the explicit release-review boundary for
simulator-owned metadata and construction behavior.
