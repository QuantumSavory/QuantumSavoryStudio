...
- **Pass criterion:** Projection is independent, nonmutating, and endpoint-exact; no backend default or legacy field is accepted; owned malformed variants and duplicate result-addressing IDs fail before side effects; declared opaque values pass while unknown/nested tags fail; physical and virtual schemas are disjoint; OpenAPI and runtime use the same nested definitions.
- **Status:** implemented
